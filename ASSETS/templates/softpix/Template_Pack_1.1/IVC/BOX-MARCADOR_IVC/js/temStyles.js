...
const Versu_Q = [
    { id_equipo: 0, img_url: "" },
    { id_equipo: 1, img_url: "./Versu_img/logo_team_1_left.png" },
    { id_equipo: 2, img_url: "./Versu_img/logo_team_2_left.png" },
    { id_equipo: 3, img_url: "./Versu_img/logo_team_3_left.png" },
    { id_equipo: 4, img_url: "./Versu_img/logo_team_4_left.png" },
    { id_equipo: 5, img_url: "./Versu_img/logo_team_5_left.png" },
    { id_equipo: 6, img_url: "./Versu_img/logo_team_6_left.png" },
    { id_equipo: 7, img_url: "./Versu_img/logo_team_7_left.png" },
    { id_equipo: 8, img_url: "./Versu_img/logo_team_8_left.png" },
  ];
const Versu_D = [
  { id_equipo: 0, img_url: "" },
  { id_equipo: 1, img_url: "./Versu_img/logo_team_1_right.png" },
  { id_equipo: 2, img_url: "./Versu_img/logo_team_2_right.png" },
  { id_equipo: 3, img_url: "./Versu_img/logo_team_3_right.png" },
  { id_equipo: 4, img_url: "./Versu_img/logo_team_4_right.png" },
  { id_equipo: 5, img_url: "./Versu_img/logo_team_5_right.png" },
  { id_equipo: 6, img_url: "./Versu_img/logo_team_6_right.png" },
  { id_equipo: 7, img_url: "./Versu_img/logo_team_7_right.png" },
  { id_equipo: 8, img_url: "./Versu_img/logo_team_8_right.png" },
  ];
