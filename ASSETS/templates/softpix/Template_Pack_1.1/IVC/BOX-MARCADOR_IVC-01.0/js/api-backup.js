    ...
    gapi.client.sheets.spreadsheets.get({
        ...
        for (var i = 0; i < sheets.length; i++) {
            ...
            gapi.client.sheets.spreadsheets.values.get({
                ...
                console.log(valueData['VALOR'][5])

               
                idta == 1? (Carreras_visitante.style.color = "#FFFFFF")  : "";
                idta == 2? (Carreras_visitante.style.color = "#000000")  : "";
                idta == 3? (Carreras_visitante.style.color = "#022499")  : "";
                idta == 4? (Carreras_visitante.style.color = "#FCBF24")  : "";
                idta == 8? (Carreras_visitante.style.color = "#000000")  : "";

                idtb == 1? (Carreras_homeclub.style.color = "#FFFFFF")  : "";
                idtb == 2? (Carreras_homeclub.style.color = "#000000")  : "";
                idtb == 3? (Carreras_homeclub.style.color = "#022499")  : "";
                idtb == 4? (Carreras_homeclub.style.color = "#FCBF24")  : "";
                idtb == 8? (Carreras_homeclub.style.color = "#000000")  : "";
