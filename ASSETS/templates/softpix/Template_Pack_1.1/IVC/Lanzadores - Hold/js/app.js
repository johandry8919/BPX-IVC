...
function runTemplateUpdate() {
  ...
  if (periodo == "TR") temporada_text = "TEMPORADA";
  if (periodo == "RR") temporada_text = "ROUND ROBIN";
  if (periodo == "F") temporada_text = "FINAL";
  PEriodo.innerHTML = temporada_text + " " + temporada;

  if (periodo == "TR" && temporada == "2023")
    PEriodo.innerHTML = "ESTA TEMPORADA";
  if (periodo == "TR" && temporada == "2021")
    PEriodo.innerHTML = "TEMPORADA 2021";
  if (periodo == "RR" && temporada == "2023")
    PEriodo.innerHTML = " ROUND ROBIN 2024";
  if (periodo == "TR" && temporada == "2022")
    PEriodo.innerHTML = "TEMPORADA 2022";
  if (periodo == "RR" && temporada == "2022")
    PEriodo.innerHTML = "ROUND ROBIN 2023";
  if (periodo == "RR" && temporada == "2021")
    PEriodo.innerHTML = "ROUND ROBIN 2022";
  if (periodo == "F" && temporada == "2022") PEriodo.innerHTML = " FINAL 2023";
  if (periodo == "F" && temporada == "2021") PEriodo.innerHTML = " FINAL 2021";
  if (periodo == "F" && temporada == "2023")
    PEriodo.innerHTML = " TEMPORADA 2024";
  if (periodo == "F" && temporada == "2020")
    PEriodo.innerHTML = " TEMPORADA 2021";
                          ...
                          datas.data.forEach((element, index) => {
                            if (element.id_picher == id_peloteros) {
                              ...
                              element.IP == undefined
                                ? (element.IP = 0)
                                : element.IP;
                              element.SO == undefined
                                ? (element.SO = 0)
                                : element.SO;
                              element.BB == undefined
                                ? (element.BB = 0)
                                : element.BB;
                              element.ERA == undefined
                                ? (element.ERA = 0)
                                : element.ERA;
                              element.HOLD == undefined
                                ? (element.HOLD = 0)
                                : element.HOLD;

                              document.getElementById("GP").innerText =
                                element.G + "/" + element.P;
                              document.getElementById("IL").innerText =
                                element.IP;
                              document.getElementById("kB").innerText =
                                element.SO + "/" + element.BB;
                              document.getElementById("EFECT").innerText =
                                element.ERA;
                              document.getElementById("HOLD").innerText = element.HOLD;
