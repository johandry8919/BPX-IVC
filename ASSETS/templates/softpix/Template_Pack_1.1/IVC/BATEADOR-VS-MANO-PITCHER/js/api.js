...
const Mano_Bateador = document.getElementById("Mano_bateador");
...
function runTemplateUpdate() {
  ...
  let Mano_bateador = htmlDecode(e("f8").innerText);
  ...
  if(Mano_bateador == "D"){
    Mano_Bateador.src = "./img/Asset.png"
    Mano_Bateador.style.left ="-120px"
  }else {
    Mano_Bateador.src = "./img/Zurdo.png"
    Mano_Bateador.style.left ="-150px"
      ...
      .then(
        function (response) {
          ...
          for (var i = 0; i < sheets.length; i++) {
            ...
            if (sheetName === "bx") {
              let datos;
              if (bateadores2 != "") datos = "!K17:M25"  , parte = 1 ;
              else if (bateadores1 != "") datos = "!K28:M36" , parte = 0;
